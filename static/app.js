/* Email Threat Analyzer — Frontend JS */
...
async function analyzeEmail() {
  ...
  if (!text) {
    showError('Please paste an email to analyze.');
    return;
  }
  ...
  try {
    ...
    btn.innerHTML = '<span class="btn-text">Run analysis</span><span class="btn-icon">⟶</span>';
  }
}
...
function showResults(data) {
  ...
  document.getElementById('verdictSeal').textContent = isPhishing ? '✕' : '✓';
